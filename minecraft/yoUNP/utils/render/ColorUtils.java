...
public class ColorUtils {
    ...
    public static Color getRainbow() {
    	//System.out.println(System.currentTimeMillis()  + "     " + Minecraft.thePlayer.ticksExisted);
    	//return new Color(Color.HSBtoRGB((float)((double)System.currentTimeMillis() / 50000.0 + Math.sin((double)1 / 50.0 * 1.6)) % 1.0f, 0.5f, 1.0f));
    	return new Color(Color.HSBtoRGB((float)((double)Minecraft.thePlayer.ticksExisted / 50.0 + Math.sin((double)1 / 50.0 * 1.6)) % 1.0f, 0.5f, 1.0f));
    }
}
