    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                ...
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText(String.valueOf((Object)((Object)EnumChatFormatting.AQUA) + "yoUNP" + " ")).setColor(EnumChatFormatting.RED).build().getChatComponent());
            }
