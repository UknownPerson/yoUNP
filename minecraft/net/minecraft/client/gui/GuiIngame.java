    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (Client.instance.getModuleManager().getModuleByClass(HUD.class).isEnabled()) {
				Gui.drawRect(0, sr.getScaledHeight() - 22, RenderUtil.width(), sr.getScaledHeight(),
						new Color(28, 28, 28, 200).getRGB());
				Gui.drawRect(i - 91 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22,
						i - 69 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight(),
						new Color(233, 233, 233, 100).getRGB());
				if (mc.isSingleplayer() == false) {
					...
					Color Worst = null;
					if (PING <= 100) {
						Worst = new Color(3110141);
					} else if (PING > 100 && PING <= 250) {
						Worst = Color.ORANGE;
					} else if (PING > 250) {
						Worst = Color.ORANGE;
					}
					this.drawFilledCircle(10, sr.getScaledHeight() - 11, 3, Worst);
					FontLoaders.Comfortaa17.drawString("PING:" + PING + "ms     FPS:" + mc.debugFPS, 16,
							sr.getScaledHeight() - FontLoaders.Comfortaa17.getStringHeight(" ")/2 -9, -1);
				} else {
					this.drawFilledCircle(10, sr.getScaledHeight() -11, 3, new Color(3110141));
					FontLoaders.Comfortaa17.drawString("PING:N/A     FPS:" + mc.debugFPS, 16,
							sr.getScaledHeight()- FontLoaders.Comfortaa17.getStringHeight(" ")/2 -9, -1);
				}
				String fuck = Client.name + " Version " + Client.version + " - " + mc.thePlayer.getName() /* + Minecraft.Name */;
				FontLoaders.Comfortaa17.drawString(fuck,
						sr.getScaledWidth() - FontLoaders.Comfortaa17.getStringWidth(fuck + " "),
						(sr.getScaledHeight() - FontLoaders.Comfortaa17.getStringHeight(fuck + " ")/2 -9), -1);
			}else {
