...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
	 ...
	 * doRender(T entity, double d, double d1, double d2, float f, float ). But JAD
	 * is pre 1.5 so doe
	 */
	...
	protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_,
		...
		if (flag || flag1) {
			...
			if ((chams = (Chams) Client.instance.getModuleManager().getModuleByClass(Chams.class)).isEnabled()
					&& chams.mode.getValue() == Chams.ChamsMode.Textured
				...
				GL11.glColor3d((double) (!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 1.0 : 0.0),
						(double) (!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 0.5 : 1.0),
						(double) (!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 0.0 : 0.0));
