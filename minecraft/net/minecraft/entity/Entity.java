...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled() || (Client.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled() && !mc.gameSettings.keyBindSprint.isKeyDown())&& this instanceof EntityPlayer;;
